...
//	}
//
//	FILE* fp = fopen( "../data/dream.xml", "r" );
//	if ( !fp ) {
...
//		}
//		doc->SaveFile( "../data/out/pretty.xml" );
//		XMLTest( "Save pretty.xml", false, doc->Error() );
//		doc->SaveFile( "../data/out/compact.xml", true );
...
//
//		doc.SaveFile( "../data/out/dreamout.xml" );
...
//
//		XMLDocument doc2;
//		doc2.LoadFile( "../data/out/dreamout.xml" );
...
//		doc.SaveFile( "../data/out/utf8testout.xml" );
//		XMLTest( "UTF-8: Save testout.xml", false, doc.Error() );
//
//		// Check the round trip.
//		bool roundTripOkay = false;
//
//		FILE* saved  = fopen( "../data/out/utf8testout.xml", "r" );
...
//	{
//		{
//			FILE* printerfp = fopen("../data/out/printer.xml", "w");
...
//		{
//			XMLDocument doc;
//			doc.LoadFile("../data/out/printer.xml");
...
//		{
//			FILE* fp1 = fopen("../data/out/printer_1.xml", "w");
...
//		{
//			XMLDocument doc;
//			doc.LoadFile("../data/out/printer_1.xml");
//			XMLTest("XMLPrinter Stream mode: load", XML_SUCCESS, doc.ErrorID(), true);
//
//			const XMLDocument& cdoc = doc;
//
...
//
//		const char* textFilePath = "../data/out/textfile.txt";
...
//			doc.SaveFile( "../data/out/bomtest.xml" );
//			XMLTest( "Save bomtest.xml", false, doc.Error() );
//        }
//		{
//			XMLDocument doc;
//			doc.LoadFile( "../data/out/bomtest.xml" );
...
//		doc.LoadFile( "../data/no-such-file.xml" );
//		XMLTest( "No such file - should fail", true, doc.Error() );
//                
//		doc.LoadFile("../data/dream.xml");
//		XMLTest("Error should be cleared", false, doc.Error());
//
//		doc.LoadFile( "../data/xmltest-5330.xml" );
...
//		const char* TESTS[] = {
//			"../data/xmltest-5330.xml",
//			"../data/xmltest-4636783552757760.xml",
//			"../data/xmltest-5720541257269248.xml",
//			0
//		};
...
//    {
//        const char* TESTS[] = {
//            "../data/xmltest-5662204197076992.xml",     // Security-level performance issue.
//            0
//        };
//        for (int i = 0; TESTS[i]; ++i) {
//            XMLDocument doc;
...
//#endif
//
//		FILE* perfFP = fopen("../data/dream.xml", "r");
